...
async def streaming_request(
    ...
    async def _streaming_body():
        ...
        # Some OpenAI-compatible servers (older SGLang, certain builds) omit usage
        # on stream end even with stream_options include_usage; without a fallback
        # MissingUsageError retries forever and no question completes.
            ...
            while wrong_attempts <= max_wrong_retries and not GLOBAL_QUIT_REQUESTED:
                ...
                while True:
                    ...
                    prompt = (
                        ...
                        # f"You may think step by step, but you must conclude with a final answer in the format: "
